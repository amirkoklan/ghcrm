{* Template: crm_opportunity_admin_preview.tpl
   Purpose: CRM Opportunity in Admin Preview
   Granite Horizon CRM *}

{if eq($node.object.current.contentobject_attributes.0.contentclass_attribute_name, 'Title')}
    <div class="crm-header">
        <h2 class="no_website">{$node.object.contentobject_attributes.0.data_text}<span class="opportunity_icon"></span></h2>
    </div><!-- ends .crm-header -->
{/if}
...
<div class="content_left">
    ...
    {if $node.data_map.title.has_content}
        <span class="client_info_left">Opportunity Title:</span>
...
<div class="right_content_wrapper">
	{include uri="design:parts/admin_preview/crm_opportunity_notes.tpl" node=$node}
