                ...
                <div class="box-bc">
                    <div class="box-ml">
                        <div class="button-left">
                            <input class="defaultbutton" type="submit" name="PublishButton" value="{'Save and Send Later'|i18n( 'design/admin/content/edit' )}" title="{'Publish the contents of the draft that is being edited. The draft will become the published version of the object. The email can be sent at a later time.'|i18n( 'design/admin/content/edit' )}" />
                            <input id="Publish" class="defaultbutton" type="submit" name="PublishButton" send="Send" value="{'Send Email Now'|i18n( 'design/admin/content/edit' )}" title="{'Send this email now. This activity has been completed.'|i18n( 'design/admin/content/edit' )}" />
